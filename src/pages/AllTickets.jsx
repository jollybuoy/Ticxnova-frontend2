  ...
  return (
    <div className="p-6 text-gray-900 bg-white min-h-screen">
      ...
      <div className="grid grid-cols-12 text-sm font-semibold text-gray-500 mb-3 px-6">
        ...
        <div className="col-span-1 ml-8 cursor-pointer" onClick={() => toggleSort("priority")}>Priority {sortIcon("priority")}</div>
        <div className="col-span-1 ml-6 cursor-pointer" onClick={() => toggleSort("status")}>Status {sortIcon("status")}</div>
